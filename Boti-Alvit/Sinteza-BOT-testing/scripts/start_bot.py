...
run_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'Bot', 'run.py')
config_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'Bot', 'accounts', _instagram_username, 'config.yml')

print(f"[INFO] Starting Bot for {_instagram_username}")
output = subprocess.Popen(
    ['python', f'{run_path}', '--config',  f'{config_path}'])
