...
import S from "@mui/base/Snackbar";
import { Button, ButtonTypeMap, ButtonProps, Tooltip } from "@mui/material";
import {
...
export const Snackbar: React.FC<ButtonProps<"button", Props>> = (props) => {
  const {
    text,
    icon,
    title,
    ...
    <React.Fragment>
      {type === "custom" ? (
        <Tooltip title={tooltip}>
          <Button onClick={handleClick} type="button" {...p}>
            {text}
          </Button>
        </Tooltip>
      ) : (
        ...
        >
          {(status) => (
            ...
            >
              ...
              <Button onClick={handleClose} className="snackbar-close-icon">
                <CloseIcon />
              </Button>
            </SnackbarContent>
          )}
